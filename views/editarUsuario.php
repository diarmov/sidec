...
<body>
    ...
    <div class="container shadow rounded mt-5">
        <div class="row">
            <div class="d-flex justify-content-center container mt-3 mb-3">
                <form id="form_usuario" name="form_usuario">
                    <h5 class="display-4">Actualización de usuario</h5>
                    <div class="form-group">
                        <label for="username">Nombre de usuario</label>
                        <input id="username" name="username" type="text" class="form-control" value="<?php echo $usuario['username']?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" name="email" type="email" class="form-control" value="<?php echo $usuario['email']?>">
                    </div>
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input id="nombre" name="nombre" type="text" class="form-control" value="<?php echo $usuario['nombre']?>">
                    </div>
                    <div class="form-group">
                        <label for="puesto">Puesto</label>
                        <input id="puesto" name="puesto" type="text" class="form-control" value="<?php echo $usuario['puesto']?>">
                    </div>
        ...
        <div class="row d-flex justify-content-center py-3 px-3">
            <button id="btn_actualizar_usuario" class="btn btn-success px-5">Actualizar usuario</button>
        </div>
    ...
    <script>
        $("#btn_actualizar_usuario").on("click", function(e) {
            $("#btn_actualizar_usuario").prop('disabled', 'disabled');
            e.preventDefault();

            $.ajax({
                url: '../controllers/usuario/editarUsuario.php',
                type: 'POST',
