...
<body>
    ...
    <div class="container mt-5 pt-5">
        <h4 class="text-center display-4">Listado de denuncias improcedentes</h4>
    ...
    <script>
        $(function() {
            $.ajax({
                url: '../controllers/denuncia/getDenunciasDesechadas.php',
                type: 'GET',
        ...
        $("#downloadXLS").click(function() {
            $("#table").table2excel({
                ...
                filename: "Denuncias improcedentes", //do not include extension
